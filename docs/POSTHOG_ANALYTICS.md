...
Replay stays disabled on authenticated dashboard routes, preview-content pages, translation editing, runtime observation, glossary/override controls, admin routes, customer-content pages, API routes, and analytics proxy routes.
