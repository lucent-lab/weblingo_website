...
const previewTestEnv = {
  ...
  NEXT_PUBLIC_POSTHOG_CAPTURE: process.env.NEXT_PUBLIC_POSTHOG_CAPTURE ?? "disabled",
  NEXT_PUBLIC_POSTHOG_HOST: process.env.NEXT_PUBLIC_POSTHOG_HOST ?? "https://eu.i.posthog.com",
  NEXT_PUBLIC_POSTHOG_REPLAY_CAPTURE: process.env.NEXT_PUBLIC_POSTHOG_REPLAY_CAPTURE ?? "disabled",
  NEXT_PUBLIC_POSTHOG_REPLAY_SAMPLE_RATE: process.env.NEXT_PUBLIC_POSTHOG_REPLAY_SAMPLE_RATE ?? "0",
