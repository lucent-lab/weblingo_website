export const ANALYTICS_EVENTS = {
  ...
  previewFeedbackSubmitted: "preview_feedback_submitted",
  ...
  agencyCustomerInvited: "agency_customer_invited",
  agencyCustomerPlanChanged: "agency_customer_plan_changed",
  ...
  siteActivated: "site_activated",
  siteDeactivated: "site_deactivated",
  ...
  domainRouteRefreshFailed: "domain_route_refresh_failed",
  domainRefreshRequested: "domain_refresh_requested",
  domainRefreshFailed: "domain_refresh_failed",
  crawlTriggered: "crawl_triggered",
  pageCrawlTriggered: "page_crawl_triggered",
  crawlTriggerFailed: "crawl_trigger_failed",
  crawlBlockedInactiveSite: "crawl_blocked_inactive_site",
  ...
  productActionFailed: "product_action_failed",
  quotaLimitHit: "quota_limit_hit",
  dashboardVisibleFailuresViewed: "dashboard_visible_failures_viewed",
...
export const BACKEND_PRODUCED_ANALYTICS_EVENTS = [
  ...
  ANALYTICS_EVENTS.crawlTriggerFailed,
  ...
  ANALYTICS_EVENTS.domainRouteRefreshFailed,
  ...
  ANALYTICS_EVENTS.pageCrawlTriggered,
  ...
  ANALYTICS_EVENTS.productActionFailed,
...
export const ANALYTICS_SAFE_PROPERTY_NAMES = [
  ...
  "dashboard_visible_failure_count",
