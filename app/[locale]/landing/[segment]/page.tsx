...
import { landingContent, landingSegments, type LandingSegment } from "@modules/landing/content";
...
export default async function LandingSegmentPage({
  params,
}: {
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Button asChild size="lg" variant="outline">
              <Link href={`/${locale}/contact`}>{t(content.cta.secondaryKey)}</Link>
            </Button>
          </div>
        </div>
      </section>
