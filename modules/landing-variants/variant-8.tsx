...
export function LandingVariant8({
  ...
  return (
    <div className={cn(styles.root, cinzel.variable, cardo.variable, "min-h-screen")}>
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-background/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <Link href={`/${locale}`} className="inline-flex items-center gap-3">
            ...
            <span className={cn(styles.display, "text-base font-semibold tracking-[0.06em] text-foreground")}>
              WebLingo
            </span>
          </Link>
      ...
      <section id="how-it-works" className="border-y border-white/10 bg-secondary/25 px-4 py-16 sm:px-6 sm:py-24">
