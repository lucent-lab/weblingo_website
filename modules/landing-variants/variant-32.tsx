...
import styles from "./variant-32.module.css";

export function LandingVariant32({
  locale,
  messages,
  t,
  content,
  ...
  return (
    <div className={cn(styles.root, "min-h-screen bg-background")}>
      ...
      <div aria-hidden className={styles.orb1} />
      <div aria-hidden className={styles.orb2} />
      <div aria-hidden className={styles.orb3} />
      ...
      >
        <div className={cn("absolute inset-0 -z-10", styles.heroGrid)} />
        <div className="relative mx-auto max-w-6xl">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="mb-6 inline-flex items-center rounded-full border border-primary/15 bg-primary/5 px-4 py-1.5 text-xs font-medium text-primary shadow-sm">
            ...
            >
              <div className="pointer-events-none absolute -inset-8 rounded-3xl bg-primary/8 blur-3xl" />
              <div
                className={cn(
                  "relative rounded-2xl border border-border bg-card/95 p-6 backdrop-blur-sm lg:max-w-md",
                  styles.formCard,
                )}
              >
          ...
          <div className="mt-12 grid gap-6 text-center sm:grid-cols-3">
            {content.stats.map((stat, idx) => (
              <div
                key={stat.valueKey}
                className={cn(
                  "rounded-2xl border border-border bg-card/80 px-6 py-5",
                  styles.depthCard,
                  styles.enter,
                )}
      ...
      >
        <div className="mx-auto max-w-5xl">
          ...
          <div className={cn("space-y-8 pl-6", styles.timeline)}>
            {content.how.items.map((item, index) => (
              <div key={item.titleKey} className={cn("flex gap-6", styles.timelineStep)}>
                <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-primary font-bold text-primary-foreground shadow-[0_4px_16px_hsl(258_60%_60%_/_0.2)]">
                  {index + 1}
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-foreground">{t(item.titleKey)}</h3>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {LANDING_FAQ_ITEMS.map((item) => (
              <div
                ...
                className={cn("rounded-2xl border border-border bg-card p-6", styles.depthCard)}
              >
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Button
              asChild
              size="lg"
              className="bg-primary shadow-[0_4px_20px_hsl(258_60%_60%_/_0.2)] hover:bg-primary/90 hover:shadow-[0_8px_30px_hsl(258_60%_60%_/_0.3)]"
            >
