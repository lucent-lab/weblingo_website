        ...
        <div className="mx-auto grid max-w-6xl items-start gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
          ...
          >
            <div
              className={cn(
                styles.stack,
                "rounded-[1.6rem] border border-border bg-card/90 p-6 shadow-xl backdrop-blur",
              )}
            >
              ...
              >
                <div className="flex gap-5">
                  <div
                    className={cn(
                      styles.display,
                      "grid h-12 w-12 flex-shrink-0 place-items-center rounded-2xl bg-primary text-primary-foreground text-base font-semibold",
                    )}
                  >
                    {index + 1}
                  </div>
