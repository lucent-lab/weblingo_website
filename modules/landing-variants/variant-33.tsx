...
import styles from "./variant-33.module.css";

export function LandingVariant33({
  locale,
  messages,
  t,
  content,
            ...
            <div className="grid gap-6">
              {content.pain.items.map((item) => (
                ...
                >
                  <div
                    className={cn(
                      "flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary",
                      styles.iconHover,
                    )}
                  >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {content.useCases.items.map((item) => (
              ...
              >
                <div
                  className={cn(
                    "mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary",
                    styles.iconHover,
                  )}
                >
                  <item.icon className="h-5 w-5" />
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-8">
            {content.how.items.map((item, index) => (
              <div key={item.titleKey} className={cn("flex gap-6", styles.stepRow)}>
                <div
                  className={cn(
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Button
              asChild
              size="lg"
              className={cn("bg-primary hover:bg-primary/90", styles.arrowBounce, styles.ctaButton)}
            >
              <Link href={`/${locale}#try`}>
                {t(content.cta.primaryKey)}
                <ArrowRight className={cn("ml-2 h-4 w-4", styles.arrowIcon)} />
              </Link>
            </Button>
