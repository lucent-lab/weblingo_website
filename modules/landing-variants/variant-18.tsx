      ...
      <section id="try" className="px-4 pb-16 pt-12 sm:px-6 sm:pb-24 sm:pt-16">
        <div className="mx-auto grid max-w-6xl items-start gap-10 lg:grid-cols-[1.06fr_0.94fr] lg:gap-14">
          <div className={cn(styles.enter)} style={{ animationDelay: "40ms" }}>
            <div className={cn(styles.kicker, "text-xs font-semibold uppercase text-muted-foreground")}>
          ...
          <aside className={cn(styles.enter, "lg:sticky lg:top-28")} style={{ animationDelay: "120ms" }}>
            <div className={cn(styles.seal, "rounded-3xl border border-border bg-card/90 p-6 shadow-xl")}>
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className={cn(styles.kicker, "text-[11px] font-semibold uppercase tracking-[0.24em] text-primary")}>
