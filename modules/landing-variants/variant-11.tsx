...
import styles from "./variant-11.module.css";
...
export function LandingVariant11({
  locale,
  messages,
  t,
  content,
  ...
  return (
    <div className={cn(styles.root, sora.variable, albert.variable, "min-h-screen font-sans")}>
      ...
      <section id="try" className="px-4 pb-16 pt-12 sm:px-6 sm:pb-24 sm:pt-16">
        <div className="mx-auto grid max-w-6xl items-start gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
          <div className={cn(styles.enter)} style={{ animationDelay: "40ms" }}>
            <div className="inline-flex flex-wrap items-center gap-3">
              <span className="rounded-full border border-border bg-card px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-foreground shadow-sm">
