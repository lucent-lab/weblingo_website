...
import styles from "./variant-34.module.css";

export function LandingVariant34({
  locale,
  messages,
  t,
  content,
  ...
  return (
    <div className={cn(styles.root, "min-h-screen bg-background")}>
      <div aria-hidden className={styles.ambientLight} />
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <h1
                className="mb-6 text-5xl font-bold leading-tight text-balance text-foreground sm:text-6xl lg:text-7xl"
                style={{ letterSpacing: "-0.03em" }}
              >
                {t(content.hero.titleKey)}
              </h1>
              <p
                className="mb-5 text-balance text-xl leading-relaxed text-muted-foreground lg:max-w-2xl"
          ...
          <div className="mt-12 grid gap-6 text-center sm:grid-cols-3">
            {content.stats.map((stat, idx) => (
              ...
              >
                <p className={cn("text-3xl font-semibold text-foreground", styles.statHighlight)}>
                  {t(stat.valueKey)}
                </p>
            ...
            {content.how.items.map((item, index) => (
              <div
                ...
                className={cn(
                  ...
                  index === content.how.items.length - 1 && styles.stepConnectorLast,
                )}
              >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {LANDING_FAQ_ITEMS.map((item) => (
              <div
                ...
                className={cn("rounded-2xl border border-border bg-card p-6", styles.glowCard)}
              >
      ...
      {/* CTA */}
      <section className={cn("px-4 py-16 sm:px-6 sm:py-24 lg:px-8", styles.ctaGradient)}>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Button
              asChild
              size="lg"
              className="bg-primary shadow-[0_4px_20px_hsl(258_60%_60%_/_0.2)] transition-all hover:bg-primary/90 hover:shadow-[0_8px_32px_hsl(258_60%_60%_/_0.3)] hover:-translate-y-0.5"
            >
